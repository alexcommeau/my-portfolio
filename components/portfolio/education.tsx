      ...
      <Reveal className="mx-auto max-w-6xl px-8 py-24">
        ...
        <div className="flex flex-wrap justify-center gap-5">
          {education.map((edu) => (
            <div
              key={edu.school}
              className="flex w-full max-w-[347px] min-h-[480px] flex-col overflow-hidden rounded-[10px] border border-zinc-800 bg-zinc-900 transition-colors hover:border-zinc-700"
            >
